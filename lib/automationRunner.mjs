...
export async function executeOneStage(job) {
  ...
  if (stage === 'research') {
    ...
    // The scheduled edition date is authoritative. Model output frequently
    // contains the event's date, which must never shift a daily edition into
    // the previous day.
